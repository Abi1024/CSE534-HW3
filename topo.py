...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        quaggaHosts.append(QuaggaHost(name='R1', ip='168.0.0.1/24',
                                      loIP=None))
        quaggaHosts.append(QuaggaHost(name='R2', ip='168.0.1.1/24',
                                      loIP=None))
        quaggaHosts.append(QuaggaHost(name='R3', ip='168.0.2.1/24',
                                      loIP=None))
        quaggaHosts.append(QuaggaHost(name='R4', ip='168.0.3.1/24',
                                      loIP=None))
